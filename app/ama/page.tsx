  ...
  return (
    <div className="border-y border-[#a2a9b1]">
      {questions.map((item) => (
        ...
        >
          <div>
            <h3 className="break-words font-serif text-base font-medium leading-6 text-[#202122] [overflow-wrap:anywhere]">
              {item.question}
            </h3>
    ...
    <WikiArticlePage currentPath="/ama" content={content}>
      <WikiArticleLayout content={content}>
        ...
        >
          ...
          {params.submitted === "1" && (
            <p role="status" className="mt-2 text-xs font-medium text-[#14866d]">
              {amaPageCopy.submittedMessage}
            </p>
          )}
          {params.error === "empty" && (
            <p role="alert" className="mt-2 text-xs font-medium text-[#b32424]">
