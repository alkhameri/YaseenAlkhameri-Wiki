      ...
      <AdminPageLayout currentWindow={window.value as WindowValue}>
        ...
        <article className="px-4 sm:px-6 py-4 text-[#202122] max-w-none">
          <div className="border border-[#a2a9b1] bg-[#f8f9fa] p-4 text-sm">
            <strong>Analytics is not configured.</strong> Set SUPABASE_URL and
            SUPABASE_SERVICE_ROLE_KEY, then run the Supabase migrations in this
            repository to populate the dashboard.
          </div>
        </article>
      </AdminPageLayout>
    );
