    ...
    <div className="flex flex-col md:flex-row">
      <main className="flex-1 w-full">
        <div className="px-4 sm:px-6 pt-4 max-w-3xl">
          ...
          {needsSetup && (
            <div className="border border-[#a2a9b1] bg-[#f8f9fa] text-[#202122] px-4 py-3 mb-4 text-sm">
              <strong>Admin is not configured.</strong> Set ADMIN_PASSWORD and
              ADMIN_SESSION_SECRET to enable this page.
            </div>
          )}
