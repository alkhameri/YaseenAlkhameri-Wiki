...
import { Github as FaGithub, Linkedin as FaLinkedin, Youtube as FaYoutube } from "lucide-react";
...
function WikiSection({ section, level }: WikiSectionProps) {
  ...
  return (
    <div className="mb-4 flow-root first:mt-0">
      ...
      {section.date && <p className="mb-2 text-xs italic text-gray-600">{section.date}</p>}
